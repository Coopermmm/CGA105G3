				...
				<div class="container right-down">
					...
					<div class="nav nav-tabs">
						...
						<button class="nav-link active" data-bs-toggle="tab"
							data-bs-target="#tab-2" aria-selected="true">文章檢舉處理</button>
						<!-- 分頁3 -->
						<button class="nav-link" data-bs-toggle="tab"
					...
					<div class="tab-content">
						...
						<div class="tab-pane show active" id="tab-2">
							...
							<form method="post" action="<%=request.getContextPath()%>/back_end/article/articleReport.do">
								...
								<div class="row">
									<div class="col-md-12">
										<span style="color: red">${errorMsgs.article_id}</span>
									</div>
								</div>
								<div class="row">
									<div class="col-md-12">
								...
								<div class="row">
									<div class="col-md-12">
										<span style="color: red">${errorMsgs.article_reportprocess_state}</span>
									</div>
								</div>
								<div class="row">
									<div class="col-md-12">
								...
								<div class="row">
									<div class="col-md-12">
										<textarea class="rArticle-text" rows="2" name="article_reportprocess_content"> ${param.article_reportprocess_content==null?articleReportVO.article_reportprocess_content:param.article_reportprocess_content} </textarea>
									</div>
								</div>
								<div class="row">
									<div class="col-md-12">
								...
								<div class="row">
									<div class="col-md-12">
										<input class="dealDate" type="text"  name="article_reportprocess_time" autocomplete="off">
									</div>
								</div>
								<div class="row">
									<div class="col-md-12">
										<span style="color: red">${errorMsgs.article_reportprocess_time}</span>
									</div>
								</div>
								<div class="row">
									<div class="col-md-12">
