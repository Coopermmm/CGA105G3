...
<link rel="stylesheet" href="<%=request.getContextPath()%>/back_end/article/css/bootstrap.min.css" type="text/css">
<!-- <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0-alpha1/dist/js/bootstrap.bundle.min.js" integrity="sha384-w76AqPfDkMBDXo30jS1Sgez6pr3x5MlQ1ZAGC+nuZB+EYdgRZgiwxhTBTkF7CXvN" crossorigin="anonymous"></script> -->
<link rel="stylesheet" href="<%=request.getContextPath()%>/back_end/article/css/back.css" type="text/css">
<link rel="stylesheet" href="<%=request.getContextPath()%>/back_end/article/css/nice-select.css" type="text/css">
<link rel="stylesheet" href="<%=request.getContextPath()%>/back_end/article/css/back_article.css" type="text/css">
<link rel="stylesheet" href="<%=request.getContextPath()%>/back_end/article/css/jquery.datetimepicker.css"
	type="text/css">
<link rel="stylesheet"
...
<body>
			...
			<section id="first">
				<div class="container right-down">
					...
					<div class="nav nav-tabs">
						...
						<!-- 分頁3 -->
						<button class="nav-link" data-bs-toggle="tab"
							data-bs-target="#tab-3" aria-selected="false">留言檢舉列表</button>
						<!-- 分頁4 -->
						<button class="nav-link active" data-bs-toggle="tab"
							data-bs-target="#tab-4" aria-selected="true">留言檢舉處理</button>
					...
					<div class="tab-content">
									...
									<tbody>
										<c:forEach var="articleReportVO" items="${listArticleReport}">
											<tr>
												...
												<td>
													<form method="post" action="<%=request.getContextPath()%>/back_end/article/articleReport.do">
									...
									<tbody>
										<c:forEach var="commentReportVO" items="${listCommetReport}">
											...
											<th>${commentReportVO.emp_id}</th>
												<td>
													<form method="post" action="<%=request.getContextPath()%>/back_end/article/commentReport.do">
						...
						<div class="tab-pane show active" id="tab-4">
							<form method="post" action="<%=request.getContextPath()%>/back_end/article/commentReport.do">
								...
								<div class="row">
									<div class="col-md-12">
										<span style="color: red">${errorMsgs.comment_id}</span>
									</div>
								</div>
								<div class="row">
									<div class="col-md-12">
								...
								<div class="row">
									<div class="col-md-12">
										<span style="color: red">${errorMsgs.comment_reportprocess_state}</span>
									</div>
								</div>
								<div class="row">
									<div class="col-md-12">
								...
								<div class="row">
									<div class="col-md-12">
										<textarea class="rComment-text" rows="2" name="comment_reportprocess_content"> ${param.comment_reportprocess_content==null?articleReportVO.comment_reportprocess_content:param.comment_reportprocess_content}</textarea>
									</div>
								</div>
								<div class="row">
									<div class="col-md-12">
								...
								<div class="row">
									<div class="col-md-12">
										<input class="dealDate" type="text" name="comment_reportprocess_time" autocomplete="off">
									</div>
								</div>
								<div class="row">
									<div class="col-md-12">
										<span style="color: red">${errorMsgs.comment_reportprocess_time}</span>
									</div>
								</div>
								<div class="row">
									<div class="col-md-12">
	...
	<script src="<%=request.getContextPath()%>/back_end/article/js/back.js"></script>
	<script src="<%=request.getContextPath()%>/back_end/article/js/bootstrap.min.js"></script>
	<script src="<%=request.getContextPath()%>/back_end/article/js/jquery.nice-select.js"></script>
	<script src="<%=request.getContextPath()%>/back_end/article/js/jquery.datetimepicker.full.js"></script>
	<script src="<%=request.getContextPath()%>/back_end/article/js/main.js"></script>
	<script src="<%=request.getContextPath()%>/back_end/article/js/back-ariticle.js"></script>
</body>
