...
//	String passwd = "ggYY8877";
	...
	private static final String INSERT_STMT = "insert into EMP(EMP_ACCOUNT,EMP_PWD,EMP_NAME,EMP_NAMEENG,EMP_IMG,EMP_STATE,EMP_DATE)\r\n"
			+ "values(?,?,?,?,?,?,?)";
	private static final String GET_ALL_STMT = "select EMP_ID,EMP_ACCOUNT,EMP_PWD,EMP_NAME,\r\n"
			+ "EMP_NAMEENG,EMP_IMG,EMP_STATE,EMP_DATE from EMP order by EMP_ID;";
	private static final String GET_ONE_STMT = "select EMP_ID,EMP_ACCOUNT,EMP_PWD,EMP_NAME,\r\n"
			+ "EMP_NAMEENG,EMP_IMG,EMP_STATE,EMP_DATE from EMP where EMP_ID = ?;";
	private static final String UPDATE = "update EMP set EMP_ACCOUNT=?, EMP_PWD=?, EMP_NAME=?, EMP_NAMEENG=?, EMP_IMG=?, EMP_STATE=?, EMP_DATE=? where EMP_ID = ?";
	private static final String GET_ONE_BYACCOUNT_STMT = "select * from EMP where EMP_ACCOUNT = ?";
